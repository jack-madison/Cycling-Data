...
for x in names:
    try:
        df = pd.read_csv("./washington_dc/bike_share/system_data/" + str(x) + ".csv")
        df['ride_count'] = 1
...
washington_bikeshare.to_csv("./washington_dc/bike_share/washington_daily_bikeshare.csv", index = False)